...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR lpCmdLine, int nCmdShow) {
	...
	hWnd = CreateWindow(
		...
		TEXT("Titulo Ficha 6 Ex2"),// Texto que figura na barra do título
		...
		/*CW_USEDEFAULT*/ 400, // Largura da janela (em pixels)
		/*CW_USEDEFAULT*/ 400, // Altura da janela (em pixels)
...
LRESULT CALLBACK TrataEventos(HWND hWnd, UINT messg, WPARAM wParam, LPARAM lParam) {
	switch (messg) {
	case WM_CLOSE:
		int res = MessageBox(hWnd, "Fechar app?", "confirmar:", MB_YESNO);
		switch (res)
		{
		case IDYES:
			DestroyWindow(hWnd);
